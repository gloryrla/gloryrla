...
| 프로젝트 | 설명 | 역할 | 성과 |
|---|---|---|---|
| **[🏎️ Physical AI 자율주행](https://github.com/gloryrla/deepracerRepo.git)** | AWS DeepRacer 강화학습 자율주행. 규칙 분석 → 속도별 손익 계산 → 5개 가설 병렬 검증 → 실차 기대 시간 기반 모델 선발 | 보상 함수 설계 · 모델 학습 | 🏆 전남대-경북대 연합 경진대회 **최우수상** |
